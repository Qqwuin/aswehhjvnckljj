...
BOT_TOKEN = getenv("BOT_TOKEN", "5515570965:AAGHmCcPKSb8P5ybYos8TcmBQDw9pSkBspM")
BOT_NAME = getenv("BOT_NAME", "son1")
API_ID = int(getenv("API_ID", "8186557"))
API_HASH = getenv("API_HASH", "efd77b34c69c164ce158037ff5a0d117")
OWNER_NAME = getenv("OWNER_NAME", "DaveDoMVid")
OWNER_USERNAME = getenv("OWNER_USERNAME", "vv9v3")
ALIVE_NAME = getenv("ALIVE_NAME", "Developer")
